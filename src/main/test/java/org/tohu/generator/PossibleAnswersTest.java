...
public class PossibleAnswersTest {
	...
	@Test
	public void testPossibleAnswers() throws Exception {
		...
		if (rb != null) {
			...
			MultipleChoiceQuestion question = new MultipleChoiceQuestion("MCQ-4");
			wm.insert(question);
			wm.fireAllRules();
		
			String possibleAnswers = question.getPossibleAnswersAsString();
	...
	@SuppressWarnings("deprecation")
	@Test
	public void testPossibleAnswersFromFile() throws Exception {
		try {
			KnowledgeBase kbase = readKnowledgeBase("org/tohu/generated/TestPossibleAnswers.drl");
			StatefulKnowledgeSession ksession = kbase.newStatefulKnowledgeSession();
			KnowledgeRuntimeLogger logger = KnowledgeRuntimeLoggerFactory.newFileLogger(ksession, "test");

			MultipleChoiceQuestion question = new MultipleChoiceQuestion("MCQ-4");
			question.setAnswerType(MultipleChoiceQuestion.TYPE_TEXT);
